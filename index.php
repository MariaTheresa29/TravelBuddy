  ...
  <div class="page">
          ...
          <div class="rd-navbar-aside">
            ...
            <div class="rd-navbar-panel">
              ...
              <div class="rd-navbar-brand">
                <!--Brand--><a class="brand" href="index.html"><img src="Template/images/logo-default-450x37.png" alt=""
              ...
              <ul class="rd-navbar-corporate-contacts">
                ...
                <li>
                  <div class="unit unit-spacing-xs">
                    ...
                    <div class="unit-body"><a class="link-phone" href="tel:#">+91 9945229110</a></div>
                  </div>
                </li>
              </ul><a class="button button-md button-default-outline-2 button-ujarak" href="login.html">Login</a>
            </div>
          </div>
        </div>
          ...
          <div class="rd-navbar-main">
            <div class="rd-navbar-nav-wrap">
              <ul class="list-inline list-inline-md rd-navbar-corporate-list-social">
                ...
                <li><a class="icon fa fa-twitter" href="https://twitter.com/i/flow/login"></a></li>
    ...
    <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2"
      ...
      <div class="swiper-wrapper text-left">
        <div class="swiper-slide context-dark" data-slide-bg="images/homepage.jpg">
              ...
              <div class="row">
                <div class="col-md-10">
                  ...
                  <h2 class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100">
                    ...
                    class="button button-default-outline button-ujarak" href="contact-us.php" data-caption-animate="fadeInLeft"
        ...
        <div class="swiper-slide context-dark" data-slide-bg="images/homepage1.jpg">
          <div class="swiper-slide-caption section-md">
            <div class="container">
              <div class="row">
                <div class="col-md-10">
        ...
        <div class="swiper-slide context-dark" data-slide-bg="images/homepage2.jpg">
          <div class="swiper-slide-caption section-md">
            <div class="container">
              <div class="row">
                <div class="col-md-10">
      ...
      <div class="container offset-negative-1">
        <div class="box-categories cta-box-wrap">
          <div class="box-categories-content">
            ...
            <br>
            <center>
              <h3><b>TRAVELERS AND THEIR PLANS</b></h3><br>
              <h5>These members are planning a trip and looking for a travel partner.<br>
                Get in touch and start discussing your plans.</ul>
              </h5>
            </center>
            <div class="row justify-content-center">
              ...
              <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                <ul class="list-marked-2 box-categories-list">
                  <li><a href="#"><img src="images/TREKKING.jpg" alt="" width="400" height="420" /></a>
                    <h5 class="box-categories-title">TREKKING</h5>
                  </li>
                </ul>
              </div>
              <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                <ul class="list-marked-2 box-categories-list">
                  <li><a href="#"><img src="images/Mountain.jpg" alt="" width="368" height="420" /></a>
              ...
              <div class="col-md-4 wow fadeInDown col-9" data-wow-delay=".2s">
                <ul class="list-marked-2 box-categories-list">
                  <li><a href="#"><img src="images/beach.jpg" alt="" width="368" /></a>
        ...
        </div><a class="button button-md button-default-outline-2 button-ujarak" href="login.html">Browse Trips<span></span></a>
        <!-- Owl Carousel-->
      </div>
    </section>
...
// Fetch profile images from the register table
$query = "SELECT profile_img FROM register";
            ...
            <div class="owl-carousel owl-classic owl-dots-secondary" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-xl-items="5" data-xxl-items="6" data-stage-padding="15" data-xxl-stage-padding="0" data-margin="30" data-autoplay="true" data-nav="true" data-dots="true">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <article class="thumbnail thumbnail-mary">
                        <div class="thumbnail-mary-figure"><img src="profile_uploads/<?php echo $profileImg; ?>" alt="" width="270" height="195" /></div>
                        <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="profile_uploads/<?php echo $profileImg; ?>" data-lightgallery="item">
                                <img src="profile_uploads/<?php echo $profileImg; ?>" alt="" width="270" height="195" /></a></div>
                    </article>
                    <?php
                }
                ?>
...
?>
    ...
    <section class="section section-sm section-first bg-default text-md-left">
      <div class="container">
        <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
          <div class="col-lg-6 text-center wow fadeInUp"><img src="images/discover.png" alt="" width="556"
              height="382" />
          </div>
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="tabs-7-1">
                    ...
                    <div class="group-md group-middle"><a class="button button-secondary button-pipaluk"
                        href="contact-us.php">Get in Touch</a><a class="button button-black-outline button-md"
                        href="about.php">Read More</a></div>
                  </div>
      ...
      <div class="container">
        ...
        <div class="row row-30 justify-content-center box-ordered">
          <div class="col-sm-6 col-md-5 col-lg-3">
            ...
            <article class="team-modern">
              <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles"
                    src="images/testimonial-1.jpg" alt="" width="118" height="118" /></a>
              ...
              <div class="team-modern-caption">
                <h6 class="team-modern-name"><a href="#">Priya</a></h6>
                <h4>
                  <p class="team-modern-status"><b>"Detailed trips"</b></p>
                </h4>
                <p class="team-modern-status">Trips created by travelers on Travel buddy are usually very detailed, so
                  it is easy to find a travel companion with a similar travel style and it is also safe</p>
                <h6 class="team-modern-phone"><a href="tel:#">+91 9731525501</a></h6>
                <br>
                <br>
                <br>
                <br>
          ...
          <div class="col-sm-6 col-md-5 col-lg-3">
            ...
            <article class="team-modern">
              <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles"
                    src="images/testimonial-2.png" alt="" width="118" height="118" /></a>
                <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70"
                  xml:space="preserve">
                  <g>
                    <path fill="#161616"
              ...
              <div class="team-modern-caption">
                ...
                <h4>
                  <p class="team-modern-status"><b>"Easy to make friends"</b></p>
                </h4>
                <p class="team-modern-status">Whenever I travelled in the US or abroad I always found someone who joined
                  me on my adventures.</p>
                <h6 class="team-modern-phone"><a href="tel:#">+91 8310018322</a></h6>
              </div>
            </article>
          </div>
          <div class="col-sm-6 col-md-5 col-lg-3">
            ...
            <article class="team-modern">
              <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles"
                    src="images/testimonial-3.png" alt="" width="118" height="118" /></a>
                <svg x="0px" y="0px" width="270px" height="70px" viewbox="0 0 270 70" enable-background="new 0 0 270 70"
                  xml:space="preserve">
                  <g>
                    <path fill="#161616"
              ...
              <div class="team-modern-caption">
                ...
                <h4>
                  <p class="team-modern-status"><b>"No Fake accounts"</b></p>
                </h4>
                <p class="team-modern-status">Travel Buddy might be the only website for finding a travel buddy where
                  you don't get spammed by fake travelers just to get money from you.</p>
    ...
    <section class="section bg-default text-center offset-top-50">
      <div class="parallax-container" data-parallax-img="images/experience.png">
        <div class="parallax-content section-xl section-inset-custom-1 context-dark bg-overlay-2-21">
          <div class="container">
            ...
            <p class="text-width-medium text-spacing-75 wow fadeInLeft" data-wow-delay=".1s">No matter how you image
              your perfect travel buddy, you can always find someone to team up with on TripGiraffe. We try to make the
              experience of finding a travel buddy as easy as possible so you can start traveling together in no time!
            </p><a class="button button-secondary button-pipaluk" href="login.html">Join Trip Now</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section-sm section-top-0 section-fluid section-relative bg-gray-4">
      <div class="container-fluid">
        <h6 class="button button-md button-default-outline-2 button-ujarak">Gallery</h6>
        <!-- Owl Carousel-->
        <div class="owl-carousel owl-classic owl-dots-secondary" data-items="1" data-sm-items="2" data-md-items="3"
          ...
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-1.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-1.jpg"
                data-lightgallery="item"><img src="images/gallery-image-1-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-2.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-2.jpg"
                data-lightgallery="item"><img src="images/gallery-image-2-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-3.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-3.jpg"
                data-lightgallery="item"><img src="images/gallery-image-3-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-4.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-4.jpg"
                data-lightgallery="item"><img src="images/gallery-image-4-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-5.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-5.jpg"
                data-lightgallery="item"><img src="images/gallery-image-5-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-6.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-6.jpg"
                data-lightgallery="item"><img src="images/gallery-image-6-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
          <!-- Thumbnail Classic-->
          <article class="thumbnail thumbnail-mary">
            <div class="thumbnail-mary-figure"><img src="images/gallery-7.1.png" alt="" width="270" height="195" />
            </div>
            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/gallery-7.jpg"
                data-lightgallery="item"><img src="images/gallery-image-7-270x195.jpg" alt="" width="270"
                  height="195" /></a>
            </div>
          </article>
        </div>
    ...
    <!-- Page Footer--><a class="banner" href="https://www.templatemonster.com/intense-multipurpose-html-template.html"
      target="_blank"><img src="images/footer.png" height="433px" alt="" /></a>
                ...
                <div class="wow slideInRight" data-wow-delay="0s">
                  ...
                  <ul class="footer-contacts d-inline-block d-sm-block">
                    <li>
                      <div class="unit">
                        <div class="unit-left"><span class="icon fa fa-phone"></span></div>
                        <div class="unit-body"><a class="link-phone" href="tel:#">080-9765432</a></div>
                      </div>
                    </li>
                    <li>
                      <div class="unit">
                        <div class="unit-left"><span class="icon fa fa-envelope"></span></div>
                        <div class="unit-body"><a class="link-aemail" href="mailto:#">info@travelbuddy.org</a></div>
                      </div>
                    </li>
                    <li>
                      <div class="unit">
                        <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                        <div class="unit-body"><a class="link-location" href="#">699 Kormangala, Bangalore,Karnataka
                            India 560033</a></div>
                      </div>
                    </li>
                  </ul>
                ...
                <div class="wow slideInDown" data-wow-delay="0s">
                  ...
                  <article class="post post-minimal-2">
                    <p class="post-minimal-2-title"><a
                        href="https://traveltriangle.com/blog/places-to-visit-in-the-world/">Your Personal Guide to 5
                        Best Places to Visit on Earth</a></p>
                    <div class="post-minimal-2-time">
                      <time datetime="2019-05-04">November 07, 2023</time>
                    </div>
                  </article>
                  <!-- Post Minimal 2-->
                  <article class="post post-minimal-2">
                    <p class="post-minimal-2-title"><a
                        href="https://www.cnbc.com/2023/09/21/what-are-the-best-hotels-in-the-world-see-the-list-of-the-top-50.html">Top
                        10 Hotels: Rating by Wonder Tour Travel Experts</a></p>
                    <div class="post-minimal-2-time">
                      <time datetime="2019-05-04">November 07, 2023</time>
                    </div>
                  </article>
              ...
              <div class="oh-desktop">
                <div class="wow slideInLeft" data-wow-delay="0s">
                  ...
                  <div class="group-md group-middle justify-content-sm-start"><a
                      class="button button-lg button-primary button-ujarak" href="contact-us.php">Get in touch</a></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
            ...
            <div class="col-sm-6 col-md-4 order-sm-first">
              ...
              <p class="rights"><span>&copy;&nbsp;</span><span
                  class="copyright-year"></span><span>&nbsp;</span><span>Travel Buddy</span>. All Rights Reserved.</p>
            </div>
